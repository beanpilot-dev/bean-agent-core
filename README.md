...
| **Analyst** | Financial analyst | Analyst LLM + ledger read and market-data tools | `ledger_account_balance`, `ledger_find_transactions`, `ledger_query`, `market_fetch_price` |
